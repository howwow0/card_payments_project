package com.howwow.carddecryptionstarter.keys.config;
...
@EnableJpaRepositories(
        basePackages = "com.howwow.carddecryptionstarter.keys",
        entityManagerFactoryRef = "keyEntityManagerFactory",
        transactionManagerRef = "keyTransactionManager"
)
@ComponentScan(basePackages = "com.howwow.carddecryptionstarter.keys")
public class KeyDbAutoConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean keyEntityManagerFactory(
        ...
        emf.setPackagesToScan("com.howwow.carddecryptionstarter.keys");
